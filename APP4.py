...
def download_and_setup_chinese_font():
    try:
        ...
        st.warning(f"下载字体时出错: {str(e)}")
        return False, None

# 尝试下载并设置中文字体
font_downloaded, font_path = download_and_setup_chinese_font()

if font_downloaded:
    st.sidebar.success("✅ 成功下载并安装思源黑体")
else:
    st.sidebar.warning("⚠️ 无法下载中文字体，图表中的中文可能无法正确显示")
    # 使用常见的中文字体作为备选
